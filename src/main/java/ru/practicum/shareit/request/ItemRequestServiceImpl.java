...
public class ItemRequestServiceImpl implements ItemRequestService {
    ...
    @Override
    public List<ItemRequestViewDto> getUserRequestsWithAnswers(Long userId) {
        User user = UserMapper.toUser(userService.findUserById(userId));
    ...
    @Override
    public List<ItemRequestViewDto> getRequestsOfOthers(Long userId, int from, int size) {
        User user = UserMapper.toUser(userService.findUserById(userId));
    ...
    @Override
    public ItemRequestViewDto getItemRequest(Long userId, Long requestId) {
        User user = UserMapper.toUser(userService.findUserById(userId));

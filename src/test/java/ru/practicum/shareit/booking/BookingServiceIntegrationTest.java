...
public class BookingServiceIntegrationTest {
    ...
    public void initialize() {
        ...
        bookingDto = new BookingRequest(1L, 1L, LocalDateTime.now().plusHours(1), LocalDateTime.now().plusDays(1), null);
    }
    ...
    public void setBookingApprovalTest() {
        ...
        BookingResponse bookingOutDto = bookingService.setBookingApproval(userId, true, bookingId);
    ...
    public void findBookingsOfUserTest() {
        ...
        List<BookingResponse> bookings = bookingService.findBookingsOfUser(BookingState.ALL, userId, 0, 10);
    ...
    public void findBookingsOfOwnerTest() {
        ...
        List<BookingResponse> bookings = bookingService.findBookingsOfOwner(BookingState.ALL, userId, 0, 10);

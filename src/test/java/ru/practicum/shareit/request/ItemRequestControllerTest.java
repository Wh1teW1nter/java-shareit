...
public class ItemRequestControllerTest {
    ...
    private ItemRequestViewDto outDto;

    @BeforeEach
    public void createRequest() {
        User user = new User(1L, "user", "user@mail.ru");
        outDto = new ItemRequestViewDto(1L, "description", user, LocalDateTime.now(), new ArrayList<>());
    }
    ...
    void getUserRequestsWithAnswersSuccessfulThenReturnListOfRequest() {
        long userId = 1L;
        List<ItemRequestViewDto> requests = List.of(outDto);

...
public class ItemRequestServiceImplTest {
    ...
    public void createFailUserNotFound() {
        ...
        assertThrows(BusinessObjectNotFoundException.class, () -> itemRequestService.create(requestInDto, userId));
    }
    ...
    public void getUserRequestsWithAnswersSuccessfulTest() {
        ...
        List<ItemRequestViewDto> requests = itemRequestService.getUserRequestsWithAnswers(userId);
    ...
    public void getUserRequestsWithAnswersFailUserNotFound() {
        ...
        assertThrows(BusinessObjectNotFoundException.class, () -> itemRequestService.getUserRequestsWithAnswers(userId));
    }
    ...
    public void getRequestsOfOthersSuccessfulTest() {
        ...
        List<ItemRequestViewDto> requests = itemRequestService.getRequestsOfOthers(userId, from, size);
    ...
    public void getRequestsOfOthersFailUserNotFound() {
        ...
        assertThrows(BusinessObjectNotFoundException.class, () -> itemRequestService.getRequestsOfOthers(userId, from, size));
    }
    ...
    public void getItemRequestSuccessfulTest() {
        ...
        ItemRequestViewDto outDto = itemRequestService.getItemRequest(userId, requestId);
    ...
    public void getItemRequestFailUserNotFound() {
        ...
        assertThrows(BusinessObjectNotFoundException.class, () -> itemRequestService.getItemRequest(userId, requestId));
    }
